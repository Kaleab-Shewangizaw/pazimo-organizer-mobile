...
/** Uses the generic PUT /auth/update-password (role-agnostic) rather than
 * organizer's /organizers/security. */
export default function CashierSecurityScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
      <View style={styles.topBar}>
        <Pressable onPress={() => goBack("/cashier/account/menu")} hitSlop={12}>
